...
class DMLClient(BlockchainClient):
    ...
    def learn(self, model=dict, participants=dict, optimizer=dict):
    ...
    def make_model(self, model: object, batch_size: int=32, 
    ...
    def make_participants(self, participants: list):
    ...
    def make_optimizer(self, opt_type="fed_avg", 
